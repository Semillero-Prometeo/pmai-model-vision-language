...
UMBRAL_CONOCIMIENTO = 0.80   # calibrar con pruebas
UMBRAL_INTERACCIONES = 0.80  # calibrar con pruebas
...
#from utils.config import MILVUS_DB_PATH, EMBED_MODEL_NAME, COL_CONOCIMIENTO